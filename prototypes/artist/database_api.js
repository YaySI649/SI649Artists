        ...
        db.transaction(function(transaction){
            ...
            transaction.executeSql((sql),[], function(transaction, results){
                ...
                if (count==0){ 
                    ...
                    //    "where (b.name) = 'Usher' group by year");
...
//select count(*), strftime('%Y', date) as year from EVENTS a join ARTISTS b on upper(a.headliner) = upper(b.name) where upper(b.name) = "USHER" group by year
